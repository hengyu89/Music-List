var songList = [
    ...
    "奔跑",  "雪人",  "问声",  "唯一",  "凉城",  "无羁",  "可能",  "炙热",  
    "偏爱",  "行歌",  "缺氧",  "非酋",  "独立",  "男孩",  "船子",  "镜中",  
    "好听",  "九月",  "塞外",  "宁夏",  "红白",  "爱我",  "撒野",  "无明",  
    "不灭",  "城府",  "尽头",  "青春",  "无问",  "知足",  "归隐",  "立秋",  
    "情话",  "腻歌",  "芊芊",  "缺氧",  "安眠",  "影子",  "飘摇",  "喷嚏",  
    "孤记",  "理由",  "云野",  "虾米",  "走狗",  "夜车",  
    ...
    "虫儿飞",  "小苹果",  "追梦人",  "我会等",  "萱草花",  "嘿姑娘",  
    "幻期颐",  "白桦林",  "丁香花",  "顺平侯",  "丑八怪",  "喵咪咪",  
    "没有人",  "在他乡",  "夜不休",  "向云端",  "程艾影",  "萌萌哒",  
    "画中仙",  "龙卷风",  "他不懂",  "小永远",  "恋人心",  "临河里",  
    "凄美地",  "给妈妈",  "芳草地",  "一瞬间",  "风浪里",  "骏马谣",  
    "小红帽",  "上山岗",  "李白说",  "同花顺",  "红昭愿",  "天上飞",  
    "醒着醉",  "嘿嘿嘿",  "关忆北",  "白亦初",  "Fly",  
    ...
    "中年少女",  "类似爱情",  "南风北巷",  "早春的树",  "你好前任",  
    "好久不见",  "爱的箴言",  "爱的天国",  "我很快乐",  "海的女儿",  
    "青鸟与诗",  "心花怒放",  "想起了你",  "就这样吧",  "我们的歌",  
    "兔子先生",  "夏日回音",  "孤独颂歌",  "一路生花",  "大笑江湖",  
    "爱就爱了",  "星光灿烂",  "潇洒小姐",  "一生有你",  "农夫渔夫",  
    "南屏晚钟",  "瓦尔登湖",  "霓虹甜心",  "三寸天堂",  "烟花易冷",  
    "空空如也",  "有心无意",  "爸爸妈妈",  "孤独城市",  "善藏不露",  
    "青蛙与马",  "深夜的歌",  "奢香夫人",  "再见迪曼",  "不了了之",  
    "断桥残雪",  "自作多情",  "城市傍晚",  "大雾回声",  "那时正好",  
    "孤独她呀",  "玫瑰窃贼",  "火柴天堂",  "青春舞曲",  "言不由衷",  
    "不是不想",  "纵火青年",  "执迷梦中",  "白衣少年",  "左手右手",  
    "星月神话",  "可惜我们",  "银河迪厅",  "海绵宝宝",  "归去来兮",  
    "百年孤寂",  "情爱不爱",  "额尔古纳",  "各生欢喜",  "湘江中路",  
    "晴空日记",  "想你想你",  "晚安宝贝",  "后会无期",  
    ...
    "认真地老去",  "生命的云彩",  "你是我的眼",  "真的不容易",  "如果寂寞了",  
    "城市动物园",  "人美路子野",  "时间里的她",  "易燃易爆炸",  "下雪的季节",  
    "北方的女王",  "森林保卫战",  "上阵父子兵",  "我想我是海",  "陆垚知马俐",  
    "明天的记忆",  "猫理不理毛",  "快点告诉你",  
    "巴黎23号",  "Upupu",  "恋爱ing",  
    ...
    "小镇英雄青年",  "你一定要幸福",  "电话里的秘密",  "我可以抱你吗",  "老司机带带我",  
    "爱的双重魔力",  "外婆的澎湖湾",  "交大东门宾馆",  "粉红色的回忆",  "寄生虫的想法",  
    "愿望交换商店",  "玫瑰花的葬礼",  "蜗牛与黄鹂鸟",  "零摄氏度月色",  "贝多芬的悲伤",  
    "越单纯越幸福",  "三月里的小雨",  "化身孤岛的鲸",  "星光下的梦想",  "流着泪说分手",  
    "月儿明风儿静",  "那女孩对我说",  "也孤独也灿烂",  "你生活在何处",  "一如年少模样",  
    "萌萌滴乖乖滴",  "分分钟需要你",  "威廉爱情故事",  "爱我就跟我走",  "万物盛开法则",  
    "下一站茶山刘",  "离开地球表面",  "亲爱的旅人啊",  "如果我不是我",  "永不失联的爱",  
    "卡比巴拉的海",  "今天是星期几",  "乌兰巴托的夜",  
    ...
    "你听了吗那首歌",  "白月光与朱砂痣",  "挥着翅膀的女孩",  "月亮代表我的心",  
    "金刚不坏大宝剑",  "酸酸甜甜就是我",  "在意识里过一生",  "不如回家陪我妈",  
    "你是我的女朋友",  "月亮粑粑咿儿哟",  "平淡日子里的刺",  "春暖花开去见你",  
    "我想对你说baby",  
    "New boy",  "Burning",  
    ...
    "孤独是生命的礼物",  "确定一定以及肯定",  "我不是随便的花朵",  "绝对占有相对自由",  
    "思念如藤蔓般蔓延",  "我的果汁分你一半",  "猫头鹰的来客通知",  "藏在微笑里的秘密",  
    "你从不知道我的心",  
    "New Girl",  

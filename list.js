var songList = [
    ...
    "你要跳舞吗",  "让寂寞别走",  "你能听见吗",  "走在冷风中",  "想你想疯了",
    "当我娶过她",  "下一个天亮",  "今日我离别",  "以后的以后",  "单身狗之歌",
    "外面的世界",  "新少女祈祷",  "盛夏的果实",  "超神的节奏",  "下个路口见",
    "种星星的人",  "红莓花儿开",  "红色高跟鞋",  "被驯服的象",  "白鸟过河滩",
    "我都跟你走",  "寂寞沙洲冷",  "秋天火车站",  "深夜地下铁",  "署前街少年",
    "一直很安静",  "匿名的好友",  "挪威的森林",  "胸大的姑娘",  "我的解放西",
    "突然的自我",  "浪花一朵朵",  "但愿人长久",  "反方向的钟",  "我爱人民币",
    "巴黎23号",
